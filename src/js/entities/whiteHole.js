...
export class WhiteHole {
  ...
  createMesh(sceneManager) {
    ...
    const innerGeometry = new CylinderGeometry(0.1, 0.4, 0, 64);
    const innerMaterial = new MeshBasicMaterial({ color: 0xffffff });
  ...
  createDistortion() {
    ...
    this.distortion.hole.mesh = new Mesh(
    ...
    this.distortion.disc.mesh = new Mesh(
